...
import AlertPakageStyles from "./styles";
...
const AlertDialog = ({ open, data, setOpen }) => {
  ...
  // get Styles
  const useStyles = AlertPakageStyles();
  ...
  return (
    <main>
      ...
      >
        <DialogContent>
          <div className={classes.alert_pakage}>
            <div className={classes.content}>
              <Typography
                variant="h6"
                sx={{
                  fontSize: smQuery && "1rem",
                  my: "0.5rem",
                  fontWeight: "500",
                }}
              >
                {t("myPakage.slide.title")}
              </Typography>
              <hr className={smQuery ? "" : "mb-4"} />
              <div>
              ...
              >
                <div className={classes.download}>
                  <div className={`${classes.img_parent} ${xsQuery && "mt-2"}`}>
                ...
                {language === "fa" && (
                  <div
                    className={`${classes.img_parent_2} ${xsQuery && "mt-2"}`}
                  >
                    <a href="https://apps.apple.com/app/rambody/id1300350064">
                      <img
                        className={classes.img_download}
            ...
            <div className={classes.img_bg}>
              <img src={data.src} alt="" className={classes.img} />
              <div className={classes.img_content}></div>
