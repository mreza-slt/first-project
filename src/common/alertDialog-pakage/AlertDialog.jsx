      ...
      >
        <div className={styles.dialog}>
          ...
          <div className={styles.content}>
            <DialogTitle>HOW DO I APPLY FOR A PACKAGE?</DialogTitle>
            <hr />
            <div>
              <div>
                <p>
                ...
                <p>
                  STEP 2<span>Search for my ID (mehdiSherafat) in the app</span>
                </p>
                <p>
                  STEP 3<span>Apply for one based on your needs and goals</span>
                </p>
                <p>
                  STEP 4
                  <span>
